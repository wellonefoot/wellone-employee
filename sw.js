'use strict';
const CACHE_VERSION='wellone-employee-v105-admin-parity-manager';
const STATIC_CACHE=`${CACHE_VERSION}-static`;
const IMAGE_CACHE=`${CACHE_VERSION}-images`;
const STATIC_FILES=['./css/admin.css?v=105','./js/employee.bundle.js?v=105','./js/employee-manage.js?v=105','./js/pwa-install.js?v=105','./manifest.webmanifest','./assets/logo.png?v=105'];
